...
<div class="product_table">
    ...
    <div class="product_row">
        ...
        <input class="product_make_in_day product_input" type="text" data-name="make_in_day">
        <input class="product_FOT product_input" type="text" data-mrot="<?=$arTreasure['mrot']?>" disabled title="MROT: <?=$arTreasure['mrot']?>">
        ...
        <input class="product_NDS product_input" type="text" disabled>
